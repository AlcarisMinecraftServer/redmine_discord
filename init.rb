...
Redmine::Plugin.register :redmine_discord do
  ...
  version '0.1.0'
  url 'https://github.com/AlcarisMinecraftServer/redmine_discord'
  author_url 'https://github.com/AlcarisMinecraftServer'

  settings({
    default: {
        'webhook_avatar_url' => 'https://raw.githubusercontent.com/AlcarisMinecraftServer/redmine_discord/gh-pages/redmine_icon.png',
